...
const SuperheroExpandableResults = ({ superhero }) => {
  if(!superhero){
    return null;
  }
  const toggleExpand = () => {
    const content = document.getElementById(`expandable-box-${superhero.id}`);
  ...
  return (
    <ExpandableBoxContainer>
      ...
      <ExpandableBoxContent id={`expandable-box-${superhero.id}`}>
...
export default SuperheroExpandableResults;
